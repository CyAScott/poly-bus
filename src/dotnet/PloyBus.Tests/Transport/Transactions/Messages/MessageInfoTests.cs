...
public class MessageInfoTests
{
    ...
    {
        // Arrange
        var header = "endpoint=user-service, type=Command, name=CreateUser, version=1.2.3";
        ...
        Assert.That(result.Name, Is.EqualTo("CreateUser"));
    ...
    {
        // Arrange
        var header = "endpoint=notification-service, type=Event, name=UserCreated, version=2.0.1";
        ...
        Assert.That(result.Name, Is.EqualTo("UserCreated"));
    ...
    public void GetAttributeFromHeader_WithExtraSpaces_ReturnsCorrectAttribute()
    {
        ...
        var header = "endpoint=payment-service, type=Command, name=ProcessPayment, version=3.14.159";
        ...
        Assert.That(result.Type, Is.EqualTo(MessageType.Command));
        Assert.That(result.Name, Is.EqualTo("ProcessPayment"));
    ...
    {
        // Arrange
        var header = "endpoint=order-service, type=command, name=PlaceOrder, version=1.0.0";
    ...
    {
        // Arrange
        var header = "endpoint=test-service, type=Command, name=TestCommand, version=";
    ...
    {
        // Arrange
        var header = "endpoint=test-service, type=Command, name=TestCommand, version=1.0";
    ...
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
    ...
    {
        // Arrange
        var attr = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
    ...
    public void Equals_WithDifferentType_ReturnsFalse()
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Event, "user-service", "CreateUser", 1, 2, 3);
    ...
    public void Equals_WithDifferentEndpoint_ReturnsFalse()
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Command, "order-service", "CreateUser", 1, 2, 3);
    ...
    public void Equals_WithDifferentName_ReturnsFalse()
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Command, "user-service", "UpdateUser", 1, 2, 3);
    ...
    public void Equals_WithDifferentMajorVersion_ReturnsFalse()
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 2, 2, 3);
    ...
    public void Equals_WithDifferentMinorVersion_ReturnsTrue()
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 3, 3);
    ...
    public void Equals_WithDifferentPatchVersion_ReturnsTrue()
    {
        // Arrange
        var attr1 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 3);
        var attr2 = new MessageInfo(MessageType.Command, "user-service", "CreateUser", 1, 2, 4);
